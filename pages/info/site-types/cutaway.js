...
export default function Cutaway() {
    return (
        <>
            <CustomHead pageTitle={'Что такое сайт-визитка?'} />
            <div className="service web-development pt-120 pb-60">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            <h4 className="mb-20">Разработка сайта-визитки</h4>
                            <p className="mb-20">Сайт-визитка — это сайт, содержащий в себе несколько страниц,
                                оформленные в едином стиле и расположены на одном доменном имени. Структура для страниц,
                                в основном одинаковая, за исключением главной страницы. Сайт-визитка обычно представляет
                                из себя информативный ресурс о компании, фрилансере или команде. Ее основная задача —
                                познакомить посетителя с деятельностью сайтовладельца (компании, фрилансера и тд.).</p>
                            <p className="mb-20-xl">Более сложные варианты сайта-визитки — ведение небольшого новостного
                                блога, для уведомления клиентов о каких-либо акциях, поздравлений или информационные
                                статьи, касаемые деятельности владельца сайта.</p>
                        </div>
                        <div className="col-lg-6">
                            <img src="/assets/img/posts/Creation process-bro.svg" alt="Что такое сайт-визитка?" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6 order-2 order-lg-1">
                            <img src="/assets/img/Portfolio-bro.svg" alt="Для кого нужен сайт-визитка?" />
                        </div>
                        <div className="col-lg-6 order-1 order-lg-2">
                            <h5 className="mb-20">Для кого нужен такой сайт?</h5>
                            <ul className="type-1">
                                <li>
                                    <strong>Малый и средний бизнес</strong>. Организации, нацеленные на оказание услуг,
                                    которые невозможно оказать онлайн.
                                </li>
                                <li>
                                    <strong>Частные юристы, адвокаты</strong>. Лица, занимающиеся юридической
                                    деятельностью.
                                </li>
                                <li>
                                    <strong>Специалисты бьюти-сферы</strong>. Специалисты, оказывающие услуги в сфере
                                    красоты в собственных салонах или на дому.
                                </li>
                                <li>
                                    <strong>Фрилансеры</strong>. Программисты, дизайнеры, копирайтеры или маркетологи,
                                    работающие на самих себя.
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div className="chart pt-60 pb-60">
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-6">
                            <div className="chart-card horizontal">
                                <ul>
                                    <ChartHorizontalOne text={'Дизайн'} color={'orange'} percentage={25} />
                                    <ChartHorizontalOne text={'Функциональность'} color={'glue'} percentage={15} />
                                    <ChartHorizontalOne text={'Информативность'} color={'gray'} percentage={60} />
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="jcc">
                                <Link href="/brief/webdev/cutaway"><a className="btn lg mt-30">Заполнить бриф</a></Link>
                            </div>
                        </div>
                    </div>
                </div>
